...
#         texts.append(f"Table {table_name} has columns: {', '.join(col_names)}")
...
#             # Primary key
#             if col["primary_key"]:
#                 texts.append(f"Column {table_name}.{col_name} is primary key")

#             if col_name in ["email", "name", "price", "total_amount"]:
#                 clean_name = col_name.replace("_", " ")
#                 entity = mapping.get(table_name, table_name)

#                 texts.append(f"Column {table_name}.{col_name} stores {entity} {clean_name}")

#         # Relationships 
#         for rel in table["relationships"]:
#             texts.append(
#                 f"{table_name}.{rel['from_column']} references "
